...
| 610 | Query parameter does not exist | In the event where you manufacture your own query params and expect DevLess to understand them I will like to say you are too kind. [List of query params](/api-engine.md) |
...
| 614 | Parameters 'where' and 'data' not set | Chances are there is something wrong with your delete payload. check it out [here](/api-engine.md) |
